...
provider package，<https://pub-web.flutter-io.cn/packages/provider>


provider package 是基于 Flutter 中的 `InheritedWidget` 实现的，用于为其子孙节点提供数据和服务。
可以将 provider 与 ChangeNotifier 结合使用。
