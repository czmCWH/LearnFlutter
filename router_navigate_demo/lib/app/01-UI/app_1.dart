import 'package:router_navigate_demo/pages/cart/cart_page.dart';
import 'package:router_navigate_demo/pages/find/find_page.dart';
import 'package:router_navigate_demo/pages/home/home_page.dart';
import 'package:router_navigate_demo/pages/mine/mine_page.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          type: BottomNavigationBarType.fixed,  // 保持选中item效果不移动、BottomNavigationBarItem 宽度不变。
